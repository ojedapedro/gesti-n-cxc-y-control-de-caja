    ...
    <div className="space-y-6">
      <div className="flex border-b border-slate-200 gap-8 mb-2 overflow-x-auto scroolbar-hide">
        ...
        <button 
          ...
          className={`pb-3 font-bold text-[15px] flex items-center gap-2 transition-colors whitespace-nowrap ${activeTab === 'gastos' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-slate-500 hover:text-slate-800'}`}
        >
